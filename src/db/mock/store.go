...
// Source: github.com/speauty/backend/db/sqlc (interfaces: Store)
...
func (m *MockStore) CreateAccount(arg0 context.Context, arg1 db2.CreateAccountParams) (db2.Account, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) CreateEntry(arg0 context.Context, arg1 db2.CreateEntryParams) (db2.Entry, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) CreateTransfer(arg0 context.Context, arg1 db2.CreateTransferParams) (db2.Transfer, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateTransfer", arg0, arg1)
	ret0, _ := ret[0].(db2.Transfer)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockStore) GetAccountById(arg0 context.Context, arg1 int64) (db2.Account, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) GetAccountByIdForUpdate(arg0 context.Context, arg1 int64) (db2.Account, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) GetEntryById(arg0 context.Context, arg1 int64) (db2.Entry, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) GetTransferById(arg0 context.Context, arg1 int64) (db2.Transfer, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) ListAccounts(arg0 context.Context, arg1 db2.ListAccountsParams) ([]db2.Account, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) ListEntries(arg0 context.Context, arg1 db2.ListEntriesParams) ([]db2.Entry, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) ListTransfers(arg0 context.Context, arg1 db2.ListTransfersParams) ([]db2.Transfer, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) SetAccountDec(arg0 context.Context, arg1 db2.SetAccountDecParams) (db2.Account, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) SetAccountInc(arg0 context.Context, arg1 db2.SetAccountIncParams) (db2.Account, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) TransferTx(arg0 context.Context, arg1 db2.TransferTxParams) (db2.TransferTxResult, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "TransferTx", arg0, arg1)
	ret0, _ := ret[0].(db2.TransferTxResult)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockStore) UpdateAccountBalance(arg0 context.Context, arg1 db2.UpdateAccountBalanceParams) (db2.Account, error) {
	m.ctrl.T.Helper()
